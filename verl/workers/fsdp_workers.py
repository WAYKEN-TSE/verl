...
class ActorRolloutRefWorker(Worker):
    ...
    def update_actor(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            with Timer(name="update_policy", logger=None) as timer:
                #self.actor: verl.workers.actor.dp_actor.py:
    ...
    def generate_sequences(self, prompts: DataProto):
        ...
        with self.rollout_sharding_manager:
            ...
            #rollout_sharding_manager:verl.workers.sharding_manager.fsdp_vllm.py:FSDPVLLMShardingManager()
            prompts = self.rollout_sharding_manager.preprocess_data(prompts)
            #self.rollout:verl.workers.rollout.vllm_rollout.py:vLLMRollout()
    ...
    def compute_log_prob(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            with adapter_ctx:
                #self.actor:verl.workers.actor.dp_actor.py DataParallelPPOActor
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        with init_context(), warnings.catch_warnings():
            ...
            if type(actor_model_config) in AutoModelForVision2Seq._model_mapping.keys():
                ...
                actor_module_class = AutoModelForCausalL
