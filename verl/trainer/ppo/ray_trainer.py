    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            ...
            for batch_dict in self.train_dataloader:
                ...
                gen_batch:
                Tensor keys: ['input_ids', 'attention_mask', 'position_ids']
                Non-tensor keys: ['raw_prompt_ids', 'multi_modal_data', 'tools_kwargs']
                '''
                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("reward", timing_raw):
                        ...
                        if self.config.reward_model.launch_reward_fn_async:
                            ...
                            #实现流程verl/verl/workers/reward_manager/naive.py
                            #具体实现：verl/verl/utils/reward_score/geo3k.py:
                            # 0.9 * acc_reward(predict_str, ground_truth) + 0.1 * format_reward(predict_str)
                            reward_tensor, reward_extra_infos_dict = compute_reward(batch, self.reward_fn)

                    # recompute old_log_probs
                    with _timer("old_log_prob", timing_raw):
                        #workers.megatron_worker.compute_log_prob  -> workers.actor.megatron_actor.compute_log_prob
