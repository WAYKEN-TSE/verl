...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> Dict[str, Any]:
    ...
    sequence_reward = batch.batch["token_level_rewards"].sum(-1)#seq_reward_shape: torch.Size([2560])

    advantages = batch.batch["advantages"]# adv_shape: torch.Size([2560, 2048])   2560=batch_size*rollout.n=512*5
    ...
    valid_adv = torch.masked_select(advantages, response_mask)#提取response_mask 对应位置为 True 的元素，生成一个一维张量
