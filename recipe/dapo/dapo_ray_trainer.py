            ...
            for batch_dict in self.train_dataloader:
                ...
                with _timer("step", timing_raw):
                    ...
                    if not self.config.algorithm.filter_groups.enable:
                        ...
                        # 在 dapo_ray_trainer.py 的 fit() 方法开头添加
                        print('*()'*30)
                        print("new batch:",new_batch.batch.keys())
                        print("Batch keys:", new_batch.non_tensor_batch.keys())
                        # print("ability:",new_batch.non_tensor_batch['ability'])
                        print('rewardmodel:',new_batch.non_tensor_batch['reward_model'])
